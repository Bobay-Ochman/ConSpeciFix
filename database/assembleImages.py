...
print "made combine.png"

#Used to produce 4-per-Page graph images.
#the absolute path listed here is a target for combined images

# targetPath = '/Volumes/APE_MacPro_External_2/brian/figures/'
# i = 0
# perPage = 4
# while i < len(species):
# 	command = 'convert '
...
# 	command+=' -append '+targetPath+'gno'+str(int(i/perPage)+1)+'.png'
# 	os.system(command)
# 	i +=perPage
